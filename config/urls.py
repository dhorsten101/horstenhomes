...
urlpatterns = [
    ...
    path("crm/accounting/", include(("apps.accounting.urls", "accounting"), namespace="accounting")),
    path("crm/dashboards/", include(("apps.dashboards.urls", "dashboards"), namespace="dashboards")),
    path("crm/leases/", include(("apps.leases.urls", "leases"), namespace="leases")),
    path("crm/estate-agents/", include(("apps.estate_agents.urls", "estate_agents"), namespace="estate_agents")),
    path("crm/managing-agents/", include(("apps.managing_agents.urls", "managing_agents"), namespace="managing_agents")),
    path("crm/rental-agents/", include(("apps.rental_agents.urls", "rental_agents"), namespace="rental_agents")),
    path("crm/contractors/", include(("apps.contractors.urls", "contractors"), namespace="contractors")),
